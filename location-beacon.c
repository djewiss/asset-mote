...
AUTOSTART_PROCESSES(&websocket_example_process, &blink_process, &multicast_example_process);
/*---------------------------------------------------------------------------*/
static void
...
//  printf("websocket %p\n", (void *)s);
  if(r == WEBSOCKET_CLOSED ||
    ...
    websocket_send_str(s, "{\"TagNumberFrom\":\"darryl_test\",\"TagNumberTarget\":\"\",\"Status\":\"Started\",\"Location\":\"\",\"EquipmentSerialNumber\":\"\"}");
         ...
         uint16_t datalen)
{
  ...
  printf("{\" 00 12 4B 00 04 0E F1 F2\":\"Gracefield\",\"Tags\":[\"00 12 4B 00 04 0E F3 88\" ]}");
  websocket_send_str(&s,"{\" 00 12 4B 00 04 0E F1 F2\":\"Gracefield\",\"Tags\":[\"00 12 4B 00 04 0E F3 88\" ]}");
